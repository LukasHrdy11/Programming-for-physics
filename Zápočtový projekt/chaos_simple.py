...
# Funkce calculate_accelerations a runge_kutta_step zůstávají stejné jako v předchozí verzi
...
# ======================= HLAVNÍ SIMULACE =============================
# Funkce run_simulation zůstává téměř stejná, jen předává G a softening
...
def main():
    ...
    if CONFIGURATION == 'chaos_3body':
        ...
        if results:
            ...
            visualize_multiple_variations(all_pos, all_ene, time_points, masses, divergence)
        else:
